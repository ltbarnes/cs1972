...
Chunk::Chunk(Point p, Point dim)
{
    ...
    int hm[32*32] = {1, 2, 3, 4, 5, 4, 5, 5, 1, 2, 3, 4, 5, 4, 5, 5, 1, 2, 3, 4, 5, 4, 5, 5, 1, 2, 3, 4, 5, 4, 5, 5,
                     2, 3, 4, 5, 6, 5, 5, 5, 2, 3, 4, 5, 6, 5, 5, 5, 2, 3, 4, 5, 6, 5, 5, 5, 2, 3, 4, 5, 6, 5, 5, 5,
                     3, 4, 5, 6, 7, 6, 5, 5, 3, 4, 5, 6, 7, 6, 5, 5, 3, 4, 5, 6, 7, 6, 5, 5, 3, 4, 5, 6, 7, 6, 5, 5,
                     4, 4, 5, 6, 6, 5, 5, 4, 4, 4, 5, 6, 6, 5, 5, 4, 4, 4, 5, 6, 6, 5, 5, 4, 4, 4, 5, 6, 6, 5, 5, 4,
                     5, 5, 5, 5, 5, 5, 4, 3, 5, 5, 5, 5, 5, 5, 4, 3, 5, 5, 5, 5, 5, 5, 4, 3, 5, 5, 5, 5, 5, 5, 4, 3,
                     6, 5, 5, 5, 4, 4, 3, 3, 6, 5, 5, 5, 4, 4, 3, 3, 6, 5, 5, 5, 4, 4, 3, 3, 6, 5, 5, 5, 4, 4, 3, 3,
                     6, 5, 4, 4, 3, 3, 3, 3, 6, 5, 4, 4, 3, 3, 3, 3, 6, 5, 4, 4, 3, 3, 3, 3, 6, 5, 4, 4, 3, 3, 3, 3,
                     5, 5, 4, 3, 3, 3, 3, 3, 5, 5, 4, 3, 3, 3, 3, 3, 5, 5, 4, 3, 3, 3, 3, 3, 5, 5, 4, 3, 3, 3, 3, 3,
                     1, 2, 3, 4, 5, 4, 5, 5, 1, 2, 3, 4, 5, 4, 5, 5, 1, 2, 3, 4, 5, 4, 5, 5, 1, 2, 3, 4, 5, 4, 5, 5,
                     2, 3, 4, 5, 6, 5, 5, 5, 2, 3, 4, 5, 6, 5, 5, 5, 2, 3, 4, 5, 6, 5, 5, 5, 2, 3, 4, 5, 6, 5, 5, 5,
                     3, 4, 5, 6, 7, 6, 5, 5, 3, 4, 5, 6, 7, 6, 5, 5, 3, 4, 5, 6, 7, 6, 5, 5, 3, 4, 5, 6, 7, 6, 5, 5,
                     4, 4, 5, 6, 6, 5, 5, 4, 4, 4, 5, 6, 6, 5, 5, 4, 4, 4, 5, 6, 6, 5, 5, 4, 4, 4, 5, 6, 6, 5, 5, 4,
                     5, 5, 5, 5, 5, 5, 4, 3, 5, 5, 5, 5, 5, 5, 4, 3, 5, 5, 5, 5, 5, 5, 4, 3, 5, 5, 5, 5, 5, 5, 4, 3,
...
void Chunk::buildChunk(int *heightMap, int w, int h)
{
    ...
    for (int z = 0; z < h; z++)
    {
        for (int x = 0; x < w; x++)
        {
            ...
            numBlocks = heightMap[mapI] + 25;
            for (int y = 0; y < numBlocks; y++)
            {
                int sides = 0;
                // check posz
                if (z == h-1 || heightMap[mapI + w] <= y-25)
                    sides |= (1 << 13);
                if (x == w-1 || heightMap[mapI + 1] <= y-25)
                    sides |= (1 << 12);
                if (z == 0 || heightMap[mapI - w] <= y-25)
                    sides |= (1 << 11);
                if (x == 0 || heightMap[mapI -1] <= y-25)
                    sides |= (1 << 10);
                if (y == numBlocks-1)
                    sides |= (1 << 9);
                if (y == 0)
